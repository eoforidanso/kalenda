...
const mobileNav = [
  ...
  { id: '__more', label: 'More', icon: <svg viewBox="0 0 20 20" fill="currentColor" className="w-5 h-5"><path fillRule="evenodd" d="M3 5a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1zM3 10a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1zM3 15a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1z" clipRule="evenodd"/></svg> },
];
...
export default function Sidebar({ view, setView, notifUnread = 0, onSearchOpen }) {
  ...
  const moreItems = [
    ...
    { id: 'mealplanner',  label: 'Meal Planner', icon: <svg viewBox="0 0 20 20" fill="currentColor" className="w-4 h-4"><path d="M3 3a1 1 0 000 2h11a1 1 0 100-2H3zM3 7a1 1 0 000 2h7a1 1 0 100-2H3zM3 11a1 1 0 100 2h4a1 1 0 100-2H3zM15 7a3 3 0 110 6 3 3 0 010-6z"/></svg> },
    { id: 'budget',       label: 'Budget',       icon: <svg viewBox="0 0 20 20" fill="currentColor" className="w-4 h-4"><path d="M4 4a2 2 0 00-2 2v1h16V6a2 2 0 00-2-2H4zM18 9H2v5a2 2 0 002 2h12a2 2 0 002-2V9zM4 13a1 1 0 011-1h1a1 1 0 110 2H5a1 1 0 01-1-1zm5-1a1 1 0 100 2h1a1 1 0 100-2H9z"/></svg> },
    ...
    { id: 'aistudio',     label: 'AI Studio',    icon: <svg viewBox="0 0 20 20" fill="currentColor" className="w-4 h-4"><path d="M11 3a1 1 0 10-2 0v1a1 1 0 102 0V3zm4.657 2.757a1 1 0 00-1.414-1.414l-.707.707a1 1 0 001.414 1.414l.707-.707zM18 10a1 1 0 01-1 1h-1a1 1 0 110-2h1a1 1 0 011 1zM5.05 6.464A1 1 0 006.464 5.05l-.707-.707a1 1 0 00-1.414 1.414l.707.707zM5 10a1 1 0 01-1 1H3a1 1 0 110-2h1a1 1 0 011 1zm3 6v-1h4v1a2 2 0 11-4 0zm4-2a4 4 0 10-4 0h4z"/></svg> },
    { id: 'memories',     label: 'Memories',     icon: <svg viewBox="0 0 20 20" fill="currentColor" className="w-4 h-4"><path fillRule="evenodd" d="M3.172 5.172a4 4 0 015.656 0L10 6.343l1.172-1.171a4 4 0 115.656 5.656L10 17.657l-6.828-6.829a4 4 0 010-5.656z" clipRule="evenodd"/></svg> },
    ...
    { id: 'location',     label: 'Location',     icon: <svg viewBox="0 0 20 20" fill="currentColor" className="w-4 h-4"><path fillRule="evenodd" d="M5.05 4.05a7 7 0 119.9 9.9L10 18.9l-4.95-4.95a7 7 0 010-9.9zM10 11a2 2 0 100-4 2 2 0 000 4z" clipRule="evenodd"/></svg> },
    { id: 'messages',     label: 'Messages',     icon: <svg viewBox="0 0 20 20" fill="currentColor" className="w-4 h-4"><path fillRule="evenodd" d="M18 10c0 3.866-3.582 7-8 7a8.841 8.841 0 01-4.083-.98L2 17l1.338-3.123C2.493 12.767 2 11.434 2 10c0-3.866 3.582-7 8-7s8 3.134 8 7zM7 9H5v2h2V9zm8 0h-2v2h2V9zM9 9h2v2H9V9z" clipRule="evenodd"/></svg> },
    { id: 'notifications', label: 'Notifs',      icon: <svg viewBox="0 0 20 20" fill="currentColor" className="w-4 h-4"><path d="M10 2a6 6 0 00-6 6v3.586l-.707.707A1 1 0 004 14h12a1 1 0 00.707-1.707L16 11.586V8a6 6 0 00-6-6zM10 18a3 3 0 01-3-3h6a3 3 0 01-3 3z"/></svg> },
    ...
    <>
      ...
      <div className="px-4 py-5" style={{ borderBottom: '1px solid #e2ecf0' }}>
        ...
        <button onClick={onSearchOpen}
          ...
          <kbd className="text-[9px] border border-gray-200 rounded px-1 font-mono text-gray-300">⌘K</kbd>
        </button>
      </div>
      ...
      <nav className="md:hidden fixed bottom-0 left-0 right-0 z-50 flex items-center justify-around px-2 py-3"
        ...
        {mobileNav.map(item => {
          ...
          const active = isMore ? moreItems.some(m => m.id === view) : view === item.id;
          return (
            <button
              key={item.id}
            ...
            <div className="grid grid-cols-4 gap-2">
              {moreItems.map(item => {
                ...
                return (
                  ...
                  >
                    <div className={`p-2 rounded-xl ${active ? 'bg-teal-50' : 'bg-gray-50'}`}>
                      {item.icon}
                    </div>
